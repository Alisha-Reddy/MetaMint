    ...
    <div className="w-[95%] md:w-[90%] grid sm:grid-cols-2 md:grid-cols-3 gap-12 mb-10 mx-auto">
      {featureArray.map(el => (
        ...
        <div className='col-start-1 col-end-[-1] row-start-1 z-10 absolute inset-x-0 -right-10 -top-5 flex items-start justify-between p-4'>
          <div className="bg-[var(--bg-color)] px-2 sm:px-4 py-1 mt-3 text-[var(--icons-color)] rounded-full">
            <div
          ...
          <div className="bg-[var(--bg-color)] px-6 py-2 text-center skew-x-[45deg] rounded-bl-lg">
        ...
        <div className="col-start-1 col-end-[-1] row-start-1 z-20 absolute -bottom-3 -left-4 w-full grid grid-cols-[1.5fr_1fr] p-4">
          <div className="bg-[var(--bg-color)] pb-2 -ml-3 skew-x-[45deg] rounded-tr-2xl relative z-10">
            <div className="skew-x-[-45deg] pl-3">
              <h4 className="text-sm sm:text-xl my-1 sm:mb-3 ml-2 font-bold">Clone #17373</h4>
      
              <div className="flex justify-between items-end">
                <div className="border border-[var(--icons-color)] px-2 sm:px-6 sm:py-1 items-center rounded-md bg-[var(--bg-color)] relative">
                  <small className="bg-[var(--bg-color)] text-[var(--icons-color)] rounded-sm px-[1px] sm:p-[2px] text-[10px] sm:text-xs absolute -top-2 sm:-top-3 left-1">
                    Current Bid
                  </small>
