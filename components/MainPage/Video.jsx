...
const Video = () => {
  return (
    ...
    <div className="sm:text-start">
        ...
        Watch, collect, and own exclusive video NFTs! Discover epic moments, rare clips, and digital collectibles that are truly one of a kind. Ready to level up your collection? 
        </p>
