    ...
    <div className='w-[95%] md:w-[90%] mb-8'>{/* subscribe */}
        <div className='w-[85%] mx-auto grid grids-cols-2 md:grid-cols-[2fr_1.5fr] gap-10 items-center justify-between'>{/* subscribe_box */}
            ...
            <div>{/* subscribe_box_left */}
                ...
                <div className='flex items-center gap-1 mt-8'>{/* subscribe_box_left_box */}
                ...
                <div className='mt-12 p-4 w-[80%] rounded-xl bg-[var(--icons-bg-color)] text-[var(--main-bg-color)] flex items-center'>{/* subscribe_box_left_input */}
                    ...
                    <RiSendPlaneFill className='text-3xl'/>{/* subscribe_box_left_input_icon */}
                </div>
            </div>
